...
digits in said guess match your secret number exactly in both digit and position (called "bulls") and 
...
# the idea is to count the existance of each number in both input and guess.
# to achieve the counter, either array/hashmap or build-in function works.
...
# the above two methods will cause duplicate counts of "bulls" if we do not subtract the number of bulls.
# while the below method, in java though, will not and it just count each letter seperately.
