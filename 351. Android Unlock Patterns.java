...
//idea is DFS, from current number to other numbers, and check if this is a valid move.
//and since this is not a combination problem, the sequence counts, so we should divide proble into 3 subsets.
//starts from corner (*4), starts from the middle of edge (*4) and starts from the middle of keyboard (only 1 mid).
