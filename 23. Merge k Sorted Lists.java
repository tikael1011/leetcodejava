...
//there are two main, or three, if you take brute force into consideration, thoughts,
//One is to build a k size heap(priority queue)
//the other is to think of merge thought and both of them rc is O(NlgK).

//here is a solution. IMHO, at least the bruteforce one should not
//be accepted b/c the huge memory consumption. if you can't load all the nodes
//into memory, your algorithm breaks.
